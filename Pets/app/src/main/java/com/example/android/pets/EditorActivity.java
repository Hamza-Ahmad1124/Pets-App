...
public class EditorActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor>
{
    ...
    {
        if(TextUtils.isEmpty(mNameEditText.getText()) && TextUtils.isEmpty(mBreedEditText.getText()) && mGender == 0 && TextUtils.isEmpty(mWeightEditText.getText()))
        {
            return;
        }
        ...
        {
            petGender = Integer.parseInt(weightString);
        }
    ...
    {
        String[] projection = new String[]{PetEntry._ID, PetEntry.COLUMN_PET_NAME, PetEntry.COLUMN_PET_BREED, PetEntry.COLUMN_PET_GENDER, PetEntry.COLUMN_PET_WEIGHT};
    ...
    public void onLoadFinished (Loader<Cursor> loader, Cursor data)
    {
        ...
        String breed = data.getString(data.getColumnIndex("breed"));
        int gender = data.getInt(data.getColumnIndex("gender"));
        int weight = data.getInt(data.getColumnIndex("weight"));
